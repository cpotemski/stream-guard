...
const PLAYER_MENU_TOGGLE_DELAY_MS = 180;
const PLAYBACK_QUALITY_TARGET_HEIGHT = 160;
const PLAYBACK_QUALITY_SETTLE_TIMEOUT_MS = 5000;
const PLAYBACK_QUALITY_SETTLE_POLL_MS = 100;
const PLAYBACK_QUALITY_SYNC_COOLDOWN_MS = 15000;
...
let playbackQualitySyncInFlight = false;
let lastPlaybackQualitySyncAt = 0;
